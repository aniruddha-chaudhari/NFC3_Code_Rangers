...
import { BarChart2, Dog, Menu, Settings,BookOpen, MessageCircle, CalendarHeart, TrendingUp, Users } from "lucide-react";
...
const SIDEBAR_ITEMS = [
    ...
    { name: "Form", icon: BookOpen, color: "#FF0000", href: "/form" },
